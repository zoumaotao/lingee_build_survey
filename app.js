...
const QUESTIONS = [
    ...
    {
        id: 'q21', section: '第五部分：商业模式与变现', type: 'single',
        title: '给客户交付完一个项目后，后续怎么处理？',
        options: [
            '交付完就结束，后续客户自己维护',
            '签了运维合同，持续提供更新和维护',
            '客户有需求再联系，按次收费',
    ...
    {
        id: 'q27', section: '第六部分：产品方向验证', type: 'single',
        title: '通用 AI 工具 vs 金蝶生态专属工具，效果差不多时你怎么选？',
        options: [
            '选专属版，更懂金蝶生态，愿意多付钱',
            '选专属版，但差价在 20% 以内',
            '看实际效果，哪个好用选哪个',
    ...
    {
        id: 'q28', section: '第六部分：产品方向验证', type: 'single',
        title: '你愿意为金蝶专属版多付多少钱？',
        showIf: { q27: '专属版' },
        options: ['多 20% 以内', '多 20-50%', '多 50-100%', '贵多少都愿意，只要真的好用']
    },
    {
    ...
    {
        id: 'q31', section: '第七部分：结尾', type: 'single',
        title: '如果这类工具真的存在，你愿意推荐给客户吗？',
        options: [
            '会，我们先用，效果好了推给客户',
            '会，直接推动客户采购，我们做实施',
            '看情况，取决于价格和效果',
