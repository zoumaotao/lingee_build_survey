...
const QUESTIONS = [
    ...
    {
        id: 'q9a', section: '第二部分：AI 使用深度', type: 'multi', max: 3,
        title: '你们主要用 AI 来做哪类工作？',
        hint: '最多选 3 项',
        options: [
            '写代码 / 补全代码 / 代码审查',
            '生成文档（需求文档、方案、报告）',
    ...
    {
        id: 'q9b', section: '第二部分：AI 使用深度', type: 'single',
        title: '目前 AI 在你们团队中处于什么阶段？',
        options: [
            '个别人偶尔试用，没有形成习惯',
            '部分人日常使用，但没有进入正式流程',
            '已融入部分工作流程，有明确提效场景',
    ...
    {
        id: 'q9c', section: '第二部分：AI 使用深度', type: 'single',
        title: 'AI 给你们带来的实际效果如何？',
        options: [
            '明显提效，节省 30% 以上时间或人力',
            '有一定帮助，大约节省 10-30% 时间',
            '偶尔有用，整体提效不明显',
